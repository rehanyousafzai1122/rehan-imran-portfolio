                ...
                <div className="flex-1 overflow-y-auto p-4 sm:p-8 bg-[#0e0e0e]">
                  ...
                  {activeTab === 'media' && (
                    <div className="space-y-8">
                      ...
                      {/* Card 3: AI Video Intro Custom Video URL */}
                      <div className="p-6 rounded-3xl bg-[#141414] border border-white/10 space-y-4">
                        <div className="flex items-center justify-between">
                          <div>
                            <span className="text-[10px] font-mono text-[#dfceb4] uppercase tracking-widest">
                            ...
                            <h5 className="text-base font-bold text-white uppercase flex items-center gap-2">
                              ...
                              <span>Custom Video Embed / Direct Stream</span>
                            </h5>
                          </div>
                        </div>

                        <p className="text-xs font-mono text-neutral-400">
                          Optionally attach an MP4 direct video URL or YouTube video link to play inside the interactive AI video player theater:
                        </p>
                        ...
                        <div className="space-y-3">
                          <input
                            ...
                            onChange={(e) =>
                              updatePersonalInfo({ videoIntroUrl: e.target.value })
                            }
                            placeholder="https://example.com/rehan-intro.mp4 or embed link"
                            className="w-full px-4 py-2.5 rounded-xl bg-black/60 border border-white/15 text-xs font-mono text-white focus:outline-none focus:border-[#dfceb4]"
                          />

                          <div>
                            <label className="block text-xs font-mono text-neutral-400 mb-1">
                              Custom Virtual Speech Script (What the presenter says):
                            </label>
                            <textarea
                              value={
                                personalInfo.videoIntroSpeechText ||
                                'Salam! My name is Rehan Imran. I am a Web & AI Developer from Rawalpindi, Pakistan. I build AI automations, computer vision apps with OpenCV, and modern web applications.'
                              }
                              onChange={(e) =>
                                updatePersonalInfo({ videoIntroSpeechText: e.target.value })
                              }
                              rows={3}
                              className="w-full px-4 py-2.5 rounded-xl bg-black/60 border border-white/15 text-xs font-mono text-white focus:outline-none focus:border-[#dfceb4]"
                            />
                          ...
                          <button
                            type="button"
                            onClick={() => showToast('Video Intro Settings Saved!')}
                            className="px-5 py-2 rounded-xl bg-[#dfceb4] text-black font-mono text-xs font-bold uppercase tracking-wider hover:bg-white transition-all shadow-md"
                          >
